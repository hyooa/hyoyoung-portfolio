        ...
        <div className='whiteBox'>
            ...
            <div>
                ...
                <div id='info'>
                    <ul>
                        <li>
                            PHP를 기반한 팀 프로젝트로 요리 레시피 사이트 개발을 하였습니다.<br></br>
                            3명의 팀원으로 구성되었고, 제가 맡은 역할은 베스트 레시피 페이지, 공지사항 페이지에 대한 UI를 구성하였습니다.<br></br>
                    ...
                    <ul>
                        ...
                        <li><span>개발기간</span> : 2022. 07. ~ 2022. 07.</li>
                    </ul>
                    <ul>
                        <li><span>Client</span> : PHP, My-SQL, JavaScript, SCSS</li>
                        <li><span>Server</span> : Heroku, Vercel</li>
                        <li><span>Library</span> : SCSS</li>
                    </ul>
                </div>
                <div id='link'>
                    <ul>
