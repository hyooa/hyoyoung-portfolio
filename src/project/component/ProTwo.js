                ...
                <div id='info'>
                    <ul>
                        <li>
                            ...
                            이를 다시 활용하여 페이지를 구성하는 연습을 해보면 좋겠다고 생각하였고, 복잡하고 많은 정보를 전달하는 기존의 홈페이지에서 <strong>최소한의 필요한 정보만 모아서 페이지를 재구성하고자 하였습니다.</strong><br></br>
                            회원가입 페이지 레이아웃 및 유효성 검사 기능을 구현하였고 <strong>관리자 페이지를 관리자 계정에서만 접속할 수 있게 따로 만들었고</strong> 그 안에서 선수, 티켓, 팀 등록 시 사진 업로드에 중점을 두어서 구현하였습니다.<br></br>
                            ...
                            결과적으로는 혼자 프로젝트를 이끌면서 <strong>성취감</strong>도 있었지만,<br></br>
